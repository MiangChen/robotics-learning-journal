...
在20世界70年代, 就已经有了经典的规划器, 比如以STRIPS为代表的先河, 但那个时候他们是用目标为导向, 而不是以过程为导向. 
...
我们会怎么拆解这个问题呢? 可以分为两个子目标, 1是要让A在B上面, 2是B在C上面. 也就是G1(on A B)和G2(on B C)
...
**第二层思考 (战术层面):** “那么，一次‘完整的寻宝往返任务’具体应该怎么做？”
