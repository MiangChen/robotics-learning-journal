...
- 主旨思想
  ...
  <img src="assets/集群任务规划.assets/截屏2025-11-04 10.26.17.png" style="zoom: 100%;" />

  - Fig3根据任务分配和存在的调度关系，明确了Dependency Types，核心问题在讨论“执行这个任务会如何影响其他任务的执行？”。下图中的线不仅仅表示时间依赖的先后顺序，也表示资源消耗的依赖关系。

  <img src="assets/集群任务规划.assets/截屏2025-11-04 10.34.39.png" style="zoom: 100%;" />
...
<img src="assets/集群任务规划.assets/Generated Image November 04, 2025 - 11_49AM.png" style="zoom: 100%;" />
...
![image-20251115200359413](assets/集群任务规划.assets/image-20251115200359413.png)
...
![image-20251115204008593](assets/集群任务规划.assets/image-20251115204008593.png)
...
![image-20251114200737120](assets/集群任务规划.assets/image-20251114200737120.png)
...
​	![image-20251114205109605](assets/集群任务规划.assets/image-20251114205109605.png)
...
![image-20251114205536450](assets/集群任务规划.assets/image-20251114205536450.png)
...
![image-20251114210126782](assets/集群任务规划.assets/image-20251114210126782.png)
...
- https://arxiv.org/pdf/2503.15836, https://intelligent-control-lab.github.io/APEX-MR/
- RSS
- 2025.3

![image-20251115144517337](assets/集群任务规划.assets/image-20251115144517337.png)
...
- 在任何时刻，一个机器人可以执行图中的任何一个动作（节点），**只要这个动作的所有“前置依赖”（指向它的边）都已经被满足（即前置动作都已完成）**。
...
![image-20251114132703360](assets/集群任务规划.assets/image-20251114132703360.png)

![image-20251114150030910](assets/集群任务规划.assets/image-20251114150030910.png)

![image-20251114144556777](assets/集群任务规划.assets/image-20251114144556777.png)
